...
For those on Microsoft Windows, the binary build is available in the file list as PooledInfRate_1.0.zip, and you can download and install that instead of the build-install.
