...
The repository/package utilizes code licensed under the terms of the
Apache Software License and therefore is licensed under ASL v2 or later.
...
with this program. If not, see [Apache
